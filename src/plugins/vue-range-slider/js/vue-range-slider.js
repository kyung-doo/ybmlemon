...
export default {
  ...
  methods: {
    ...
    getPos(e) {
      ...
      return this.direction === 'vertical' ? (this.reverse ? (e.pageY - this.offset)* window.zoomScale : ((this.size - (e.pageY - this.offset))* window.zoomScale)) : (this.reverse ? ((this.size - (e.pageX - this.offset))* window.zoomScale) : (e.pageX - this.offset)* window.zoomScale)
    },
